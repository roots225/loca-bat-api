...
export declare class TenantController {
    ...
    store(dto: addTenantDto): Promise<{
        success: boolean;
        data: {
            user_id: number;
            agency_id: number;
    ...
    getOneOwner(dto: getByIdDto): Promise<{
        success: boolean;
    ...
    storeTenantProperty(dto: addTenantPropertyDto): Promise<{
        success: boolean;
        data: import("@prisma/client/runtime").GetResult<{
            id: number;
            tenant_id: number;
    ...
    deleteOwner(dto: getByIdDto): Promise<{
        success: boolean;
        data: import("@prisma/client/runtime").GetResult<{
            user_id: number;
            agency_id: number;
